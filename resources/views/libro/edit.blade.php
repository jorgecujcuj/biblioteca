                        ...
                        <form method="POST" action="{{ route('libros.update', $libro->idlibro) }}"  role="form" enctype="multipart/form-data">
                            ...
                            <div class="box box-info padding-1">
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="imglibro" class="col-md-4 col-form-label text-md-right">{{ __("Imagen anterior") }}</label>

                                        <div class="col-md-6">
                                            <input id="imglibro" type="text" disabled="disabled" class="form-control @error('imglibro') is-invalid @enderror" name="imglibro" value="{{ old('imglibro',$libro->imglibro) }}" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="titulolibro" type="text" disabled="disabled" class="form-control @error('titulolibro') is-invalid @enderror" name="titulolibro" value="{{ old('titulolibro',$libro->titulolibro) }}" >
