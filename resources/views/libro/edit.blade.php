                        ...
                        <form method="POST" action="{{ route('libros.update', $libro->idlibro) }}"  role="form" enctype="multipart/form-data">
                            ...
                            <div class="box box-info padding-1">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="titulolibro">Adjuntar Nuevo Libro</label>
                                        <input type="file" accept="application/pdf" name="titulolibro" id="titulolibro" class="form-control-file">
                                        @error('titulolibro')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="titulolibro">Libro anterior</label>
                                        <input id="titulo" type="text" disabled="disabled" class="form-control @error('titulolibro') is-invalid @enderror" name="titulo" value="{{ old('titulolibro',$libro->titulolibro) }}" >
                                    </div>
